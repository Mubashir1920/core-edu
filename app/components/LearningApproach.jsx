        ...
        <section className="py-20 px-5 md:px-0">
            ...
            >
                <div className="flex flex-col md:flex-row gap-6 items-center ">
                    ...
                    <motion.div
                        className="relative w-full md:flex hidden justify-center md:w-1/2 h-[240px] md:h-[300px]"
                    ...
                    <motion.div className="w-full md:w-1/2" variants={itemVariants}>
                        <motion.div
                            className="text-lg uppercase text-black/50 tracking-tight mb-2"
                            variants={itemVariants}
                        >
                            OUR APPROACH
                        </motion.div>
                        ...
                        <motion.h2
                            className="text-4xl tracking-tighter font-bold mb-4"
                            variants={itemVariants}
                        >
                        ...
                        <motion.p
                            className="text-darkgray mb-6 tracking-tight text-lg"
                            variants={itemVariants}
                        >
